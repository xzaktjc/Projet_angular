...
exports.EncryptionSpecServiceClient = void 0;
 ...
 */
const gapicConfig = require("./encryption_spec_service_client_config.json");
...
class EncryptionSpecServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const initializeEncryptionSpecResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.InitializeEncryptionSpecResponse');
        const initializeEncryptionSpecMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.InitializeEncryptionSpecMetadata');
        this.descriptors.longrunning = {
            initializeEncryptionSpec: new this._gaxModule.LongrunningDescriptor(this.operationsClient, initializeEncryptionSpecResponse.decode.bind(initializeEncryptionSpecResponse), initializeEncryptionSpecMetadata.decode.bind(initializeEncryptionSpecMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2beta1.EncryptionSpecService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.encryptionSpecServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.dialogflow.v2beta1.EncryptionSpecService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.dialogflow.v2beta1.EncryptionSpecService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const encryptionSpecServiceStubMethods = ['getEncryptionSpec', 'initializeEncryptionSpec'];
        for (const methodName of encryptionSpecServiceStubMethods) {
            const callPromise = this.encryptionSpecServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getEncryptionSpec(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    initializeEncryptionSpec(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkInitializeEncryptionSpecProgress(name) {
...
//# sourceMappingURL=encryption_spec_service_client.js.map