...
class ParticipantsClient {
    ...
    initialize() {
        ...
        const participantsStubMethods = ['createParticipant', 'getParticipant', 'listParticipants', 'updateParticipant', 'analyzeContent', 'streamingAnalyzeContent', 'bidiStreamingAnalyzeContent', 'suggestArticles', 'suggestFaqAnswers', 'suggestSmartReplies', 'suggestKnowledgeAssist', 'listSuggestions', 'compileSuggestion'];
    ...
    suggestKnowledgeAssist(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    bidiStreamingAnalyzeContent(options) {
        this.initialize().catch(err => { throw err; });
