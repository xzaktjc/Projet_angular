...
class SessionEntityTypesClient {
    ...
    initialize() {
        ...
        this.sessionEntityTypesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.dialogflow.v2beta1.SessionEntityTypes, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const sessionEntityTypesStubMethods = ['listSessionEntityTypes', 'getSessionEntityType', 'createSessionEntityType', 'updateSessionEntityType', 'deleteSessionEntityType'];
    ...
    getSessionEntityType(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.getSessionEntityType(request, options, wrappedCallback)
    ...
    createSessionEntityType(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.createSessionEntityType(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('createSessionEntityType response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    updateSessionEntityType(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.updateSessionEntityType(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('updateSessionEntityType response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    deleteSessionEntityType(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.deleteSessionEntityType(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('deleteSessionEntityType response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
