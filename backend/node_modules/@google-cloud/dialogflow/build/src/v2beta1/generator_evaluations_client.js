...
exports.GeneratorEvaluationsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v2beta1/generator_evaluations_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./generator_evaluations_client_config.json");
 ...
 * @memberof v2beta1
 */
class GeneratorEvaluationsClient {
    _terminated = false;
    _opts;
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            generatorEvaluationPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/generators/{generator}/evaluations/{evaluation}'),
            ...
            projectLocationPhoneNumberPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/phoneNumbers/{phone_number}'),
            projectPhoneNumberPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/phoneNumbers/{phone_number}'),
            sipTrunkPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/sipTrunks/{siptrunk}'),
            toolPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/tools/{tool}'),
        };
        // Some of the methods on this service return "paged" results,
        // (e.g. 50 results at a time, with tokens to get subsequent
        // pages). Denote the keys used for pagination and results.
        this.descriptors.page = {
            listGeneratorEvaluations: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'generatorEvaluations')
        };
        ...
        const createGeneratorEvaluationResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.GeneratorEvaluation');
        const createGeneratorEvaluationMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.GeneratorEvaluationOperationMetadata');
        this.descriptors.longrunning = {
            createGeneratorEvaluation: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createGeneratorEvaluationResponse.decode.bind(createGeneratorEvaluationResponse), createGeneratorEvaluationMetadata.decode.bind(createGeneratorEvaluationMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2beta1.GeneratorEvaluations', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.generatorEvaluationsStub) {
            return this.generatorEvaluationsStub;
        }
        // Put together the "service stub" for
        // google.cloud.dialogflow.v2beta1.GeneratorEvaluations.
        this.generatorEvaluationsStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.dialogflow.v2beta1.GeneratorEvaluations') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.dialogflow.v2beta1.GeneratorEvaluations, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const generatorEvaluationsStubMethods = ['createGeneratorEvaluation', 'getGeneratorEvaluation', 'listGeneratorEvaluations', 'deleteGeneratorEvaluation'];
        for (const methodName of generatorEvaluationsStubMethods) {
            const callPromise = this.generatorEvaluationsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getGeneratorEvaluation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        this._log.info('getGeneratorEvaluation request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('getGeneratorEvaluation response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.getGeneratorEvaluation(request, options, wrappedCallback)
    ...
    deleteGeneratorEvaluation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize().catch(err => { throw err; });
        this._log.info('deleteGeneratorEvaluation request %j', request);
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('deleteGeneratorEvaluation response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.deleteGeneratorEvaluation(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('deleteGeneratorEvaluation response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    createGeneratorEvaluation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, rawResponse, _) => {
                this._log.info('createGeneratorEvaluation response %j', rawResponse);
                callback(error, response, rawResponse, _); // We verified callback above.
            }
            : undefined;
        this._log.info('createGeneratorEvaluation request %j', request);
        return this.innerApiCalls.createGeneratorEvaluation(request, options, wrappedCallback)
     ...
     */
    async checkCreateGeneratorEvaluationProgress(name) {
        this._log.info('createGeneratorEvaluation long-running');
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createGeneratorEvaluation, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    listGeneratorEvaluations(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, values, nextPageRequest, rawResponse) => {
                this._log.info('listGeneratorEvaluations values %j', values);
                callback(error, values, nextPageRequest, rawResponse); // We verified callback above.
            }
            : undefined;
        this._log.info('listGeneratorEvaluations request %j', request);
        return this.innerApiCalls
            .listGeneratorEvaluations(request, options, wrappedCallback)
            ?.then(([response, input, output]) => {
            this._log.info('listGeneratorEvaluations values %j', response);
     ...
     *   for more details and examples.
     */
    listGeneratorEvaluationsStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const defaultCallSettings = this._defaults['listGeneratorEvaluations'];
        const callSettings = defaultCallSettings.merge(options);
        this.initialize().catch(err => { throw err; });
        this._log.info('listGeneratorEvaluations stream %j', request);
        return this.descriptors.page.listGeneratorEvaluations.createStream(this.innerApiCalls.listGeneratorEvaluations, request, callSettings);
    }
    /**
     ...
     */
    listGeneratorEvaluationsAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize().catch(err => { throw err; });
        this._log.info('listGeneratorEvaluations iterate %j', request);
        return this.descriptors.page.listGeneratorEvaluations.asyncIterate(this.innerApiCalls['listGeneratorEvaluations'], request, callSettings);
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    generatorEvaluationPath(project, location, generator, evaluation) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromGeneratorEvaluationName(generatorEvaluationName) {
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromGeneratorEvaluationName(generatorEvaluationName) {
     ...
     * @returns {string} A string representing the generator.
     */
    matchGeneratorFromGeneratorEvaluationName(generatorEvaluationName) {
     ...
     */
    matchEvaluationFromGeneratorEvaluationName(generatorEvaluationName) {
     ...
     * @returns {string} Resource name string.
     */
    projectConversationsPath(project, conversation) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectConversationsName(projectConversationsName) {
     ...
     * @returns {string} A string representing the conversation.
     */
    matchConversationFromProjectConversationsName(projectConversationsName) {
     ...
     * @returns {string} Resource name string.
     */
    projectLocationConversationsPath(project, location, conversation) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectLocationConversationsName(projectLocationConversationsName) {
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromProjectLocationConversationsName(projectLocationConversationsName) {
     ...
     * @returns {string} A string representing the conversation.
     */
    matchConversationFromProjectLocationConversationsName(projectLocationConversationsName) {
     ...
     * @returns {string} Resource name string.
     */
    projectLocationPhoneNumberPath(project, location, phoneNumber) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectLocationPhoneNumberName(projectLocationPhoneNumberName) {
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromProjectLocationPhoneNumberName(projectLocationPhoneNumberName) {
     ...
     */
    matchPhoneNumberFromProjectLocationPhoneNumberName(projectLocationPhoneNumberName) {
     ...
     * @returns {string} Resource name string.
     */
    projectPhoneNumberPath(project, phoneNumber) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectPhoneNumberName(projectPhoneNumberName) {
     ...
     * @returns {string} A string representing the phone_number.
     */
    matchPhoneNumberFromProjectPhoneNumberName(projectPhoneNumberName) {
     ...
     * @returns {string} Resource name string.
     */
    sipTrunkPath(project, location, siptrunk) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromSipTrunkName(sipTrunkName) {
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromSipTrunkName(sipTrunkName) {
     ...
     */
    matchSiptrunkFromSipTrunkName(sipTrunkName) {
     ...
     * @returns {string} Resource name string.
     */
    toolPath(project, location, tool) {
     ...
     */
    close() {
        if (this.generatorEvaluationsStub && !this._terminated) {
            return this.generatorEvaluationsStub.then(stub => {
...
exports.GeneratorEvaluationsClient = GeneratorEvaluationsClient;
//# sourceMappingURL=generator_evaluations_client.js.map