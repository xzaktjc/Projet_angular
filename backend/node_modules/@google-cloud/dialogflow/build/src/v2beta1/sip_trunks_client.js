...
exports.SipTrunksClient = void 0;
const jsonProtos = require("../../protos/protos.json");
const google_gax_1 = require("google-gax");
/**
 * Client JSON configuration object, loaded from
 * `src/v2beta1/sip_trunks_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./sip_trunks_client_config.json");
...
class SipTrunksClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listSipTrunks: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'sipTrunks')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2beta1.SipTrunks', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.sipTrunksStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.dialogflow.v2beta1.SipTrunks') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.dialogflow.v2beta1.SipTrunks, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const sipTrunksStubMethods = ['createSipTrunk', 'deleteSipTrunk', 'listSipTrunks', 'getSipTrunk', 'updateSipTrunk'];
        for (const methodName of sipTrunksStubMethods) {
            const callPromise = this.sipTrunksStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createSipTrunk(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    deleteSipTrunk(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    getSipTrunk(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    updateSipTrunk(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listSipTrunks(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    listSipTrunksStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listSipTrunks.createStream(this.innerApiCalls.listSipTrunks, request, callSettings);
    }
    /**
     ...
     */
    listSipTrunksAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listSipTrunks.asyncIterate(this.innerApiCalls['listSipTrunks'], request, callSettings);
    }
    /**
...
exports.SipTrunksClient = SipTrunksClient;
//# sourceMappingURL=sip_trunks_client.js.map