...
class ConversationProfilesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const setSuggestionFeatureConfigResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.ConversationProfile');
        const setSuggestionFeatureConfigMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.SetSuggestionFeatureConfigOperationMetadata');
        const clearSuggestionFeatureConfigResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.ConversationProfile');
        const clearSuggestionFeatureConfigMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.ClearSuggestionFeatureConfigOperationMetadata');
        this.descriptors.longrunning = {
            setSuggestionFeatureConfig: new this._gaxModule.LongrunningDescriptor(this.operationsClient, setSuggestionFeatureConfigResponse.decode.bind(setSuggestionFeatureConfigResponse), setSuggestionFeatureConfigMetadata.decode.bind(setSuggestionFeatureConfigMetadata)),
            clearSuggestionFeatureConfig: new this._gaxModule.LongrunningDescriptor(this.operationsClient, clearSuggestionFeatureConfigResponse.decode.bind(clearSuggestionFeatureConfigResponse), clearSuggestionFeatureConfigMetadata.decode.bind(clearSuggestionFeatureConfigMetadata))
        };
    ...
    initialize() {
        ...
        this.conversationProfilesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.dialogflow.v2beta1.ConversationProfiles, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const conversationProfilesStubMethods = ['listConversationProfiles', 'getConversationProfile', 'createConversationProfile', 'updateConversationProfile', 'deleteConversationProfile', 'setSuggestionFeatureConfig', 'clearSuggestionFeatureConfig'];
    ...
    setSuggestionFeatureConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkSetSuggestionFeatureConfigProgress(name) {
    ...
    clearSuggestionFeatureConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkClearSuggestionFeatureConfigProgress(name) {
