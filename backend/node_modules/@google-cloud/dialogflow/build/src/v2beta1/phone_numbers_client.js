 ...
 * `src/v2beta1/phone_numbers_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./phone_numbers_client_config.json");
...
class PhoneNumbersClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listPhoneNumbers: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'phoneNumbers')
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2beta1.PhoneNumbers', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.phoneNumbersStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.dialogflow.v2beta1.PhoneNumbers') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.dialogflow.v2beta1.PhoneNumbers, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const phoneNumbersStubMethods = ['listPhoneNumbers', 'updatePhoneNumber', 'deletePhoneNumber', 'undeletePhoneNumber'];
        for (const methodName of phoneNumbersStubMethods) {
            const callPromise = this.phoneNumbersStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    updatePhoneNumber(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.updatePhoneNumber(request, options, wrappedCallback)
    ...
    deletePhoneNumber(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.deletePhoneNumber(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('deletePhoneNumber response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    undeletePhoneNumber(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.undeletePhoneNumber(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('undeletePhoneNumber response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    listPhoneNumbers(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    listPhoneNumbersStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listPhoneNumbers.createStream(this.innerApiCalls.listPhoneNumbers, request, callSettings);
    }
    /**
     ...
     */
    listPhoneNumbersAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        return this.descriptors.page.listPhoneNumbers.asyncIterate(this.innerApiCalls['listPhoneNumbers'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=phone_numbers_client.js.map