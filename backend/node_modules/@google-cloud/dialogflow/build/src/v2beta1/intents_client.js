...
class IntentsClient {
    ...
    initialize() {
        ...
        const intentsStubMethods = ['listIntents', 'getIntent', 'createIntent', 'updateIntent', 'deleteIntent', 'batchUpdateIntents', 'batchDeleteIntents'];
    ...
    batchUpdateIntents(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.batchUpdateIntents(request, options, wrappedCallback)
    ...
    async checkBatchUpdateIntentsProgress(name) {
        ...
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.batchUpdateIntents, this._gaxModule.createDefaultBackoffSettings());
    ...
    batchDeleteIntents(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.batchDeleteIntents(request, options, wrappedCallback)
            ?.then(([response, rawResponse, _]) => {
            this._log.info('batchDeleteIntents response %j', rawResponse);
            return [response, rawResponse, _];
        });
    ...
    async checkBatchDeleteIntentsProgress(name) {
        ...
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.batchDeleteIntents, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
