 ...
 * @memberof v2beta1
 */
export declare class EncryptionSpecServiceClient {
    private _terminated;
    private _opts;
    ...
    encryptionSpecServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     ...
     */
    getEncryptionSpec(request?: protos.google.cloud.dialogflow.v2beta1.IGetEncryptionSpecRequest, options?: CallOptions): Promise<[
    ...
    getEncryptionSpec(request: protos.google.cloud.dialogflow.v2beta1.IGetEncryptionSpecRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2beta1.IEncryptionSpec, protos.google.cloud.dialogflow.v2beta1.IGetEncryptionSpecRequest | null | undefined, {} | null | undefined>): void;
    getEncryptionSpec(request: protos.google.cloud.dialogflow.v2beta1.IGetEncryptionSpecRequest, callback: Callback<protos.google.cloud.dialogflow.v2beta1.IEncryptionSpec, protos.google.cloud.dialogflow.v2beta1.IGetEncryptionSpecRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    initializeEncryptionSpec(request?: protos.google.cloud.dialogflow.v2beta1.IInitializeEncryptionSpecRequest, options?: CallOptions): Promise<[
    ...
    initializeEncryptionSpec(request: protos.google.cloud.dialogflow.v2beta1.IInitializeEncryptionSpecRequest, options: CallOptions, callback: Callback<LROperation<protos.google.cloud.dialogflow.v2beta1.IInitializeEncryptionSpecResponse, protos.google.cloud.dialogflow.v2beta1.IInitializeEncryptionSpecMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    initializeEncryptionSpec(request: protos.google.cloud.dialogflow.v2beta1.IInitializeEncryptionSpecRequest, callback: Callback<LROperation<protos.google.cloud.dialogflow.v2beta1.IInitializeEncryptionSpecResponse, protos.google.cloud.dialogflow.v2beta1.IInitializeEncryptionSpecMetadata>, protos.google.longrunning.IOperation | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * region_tag:dialogflow_v2beta1_generated_EncryptionSpecService_InitializeEncryptionSpec_async
     */
    checkInitializeEncryptionSpecProgress(name: string): Promise<LROperation<protos.google.cloud.dialogflow.v2beta1.InitializeEncryptionSpecResponse, protos.google.cloud.dialogflow.v2beta1.InitializeEncryptionSpecMetadata>>;
    /**
