...
class EntityTypesClient {
    ...
    initialize() {
        ...
        const entityTypesStubMethods = ['getEntityType', 'createEntityType', 'updateEntityType', 'deleteEntityType', 'listEntityTypes', 'exportEntityTypes', 'importEntityTypes'];
    ...
    exportEntityTypes(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.exportEntityTypes(request, options, wrappedCallback)
    ...
    importEntityTypes(request, optionsOrCallback, callback) {
        ...
        return this.innerApiCalls.importEntityTypes(request, options, wrappedCallback)
            ?.then(([response, rawResponse, _]) => {
            this._log.info('importEntityTypes response %j', rawResponse);
            return [response, rawResponse, _];
        });
