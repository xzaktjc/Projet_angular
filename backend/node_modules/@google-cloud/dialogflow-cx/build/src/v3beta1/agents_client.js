...
class AgentsClient {
    ...
    initialize() {
        ...
        const agentsStubMethods = ['listAgents', 'getAgent', 'createAgent', 'updateAgent', 'deleteAgent', 'exportAgent', 'restoreAgent', 'validateAgent', 'getAgentValidationResult', 'getGenerativeSettings', 'updateGenerativeSettings'];
    ...
    validateAgent(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('validateAgent response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.validateAgent(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('validateAgent response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    getAgentValidationResult(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('getAgentValidationResult response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.getAgentValidationResult(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('getAgentValidationResult response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    getGenerativeSettings(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('getGenerativeSettings response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.getGenerativeSettings(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('getGenerativeSettings response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    updateGenerativeSettings(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('updateGenerativeSettings response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.updateGenerativeSettings(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('updateGenerativeSettings response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
