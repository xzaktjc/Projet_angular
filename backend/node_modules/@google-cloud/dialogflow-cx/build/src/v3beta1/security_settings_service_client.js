...
class SecuritySettingsServiceClient {
    ...
    initialize() {
        ...
        this.securitySettingsServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.cloud.dialogflow.cx.v3beta1.SecuritySettingsService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const securitySettingsServiceStubMethods = ['createSecuritySettings', 'getSecuritySettings', 'updateSecuritySettings', 'listSecuritySettings', 'deleteSecuritySettings'];
