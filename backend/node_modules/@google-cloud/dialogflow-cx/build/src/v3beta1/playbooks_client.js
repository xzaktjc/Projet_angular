...
class PlaybooksClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            conversationPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/agents/{agent}/conversations/{conversation}'),
            ...
            toolVersionPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/agents/{agent}/tools/{tool}/versions/{version}'),
        ...
        const exportPlaybookResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ExportPlaybookResponse');
        const exportPlaybookMetadata = protoFilesRoot.lookup('.google.protobuf.Struct');
        const importPlaybookResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ImportPlaybookResponse');
        const importPlaybookMetadata = protoFilesRoot.lookup('.google.protobuf.Struct');
        this.descriptors.longrunning = {
            exportPlaybook: new this._gaxModule.LongrunningDescriptor(this.operationsClient, exportPlaybookResponse.decode.bind(exportPlaybookResponse), exportPlaybookMetadata.decode.bind(exportPlaybookMetadata)),
            importPlaybook: new this._gaxModule.LongrunningDescriptor(this.operationsClient, importPlaybookResponse.decode.bind(importPlaybookResponse), importPlaybookMetadata.decode.bind(importPlaybookMetadata))
        };
    ...
    initialize() {
        ...
        const playbooksStubMethods = ['createPlaybook', 'deletePlaybook', 'listPlaybooks', 'getPlaybook', 'exportPlaybook', 'importPlaybook', 'updatePlaybook', 'createPlaybookVersion', 'getPlaybookVersion', 'restorePlaybookVersion', 'listPlaybookVersions', 'deletePlaybookVersion'];
    ...
    createPlaybook(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.createPlaybook(request, options, wrappedCallback)
    ...
    deletePlaybook(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.deletePlaybook(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('deletePlaybook response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    getPlaybook(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.getPlaybook(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('getPlaybook response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    updatePlaybook(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.updatePlaybook(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('updatePlaybook response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    createPlaybookVersion(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.createPlaybookVersion(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('createPlaybookVersion response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    getPlaybookVersion(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.getPlaybookVersion(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('getPlaybookVersion response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    restorePlaybookVersion(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, options, rawResponse) => {
                this._log.info('restorePlaybookVersion response %j', response);
                callback(error, response, options, rawResponse); // We verified callback above.
            }
            : undefined;
        return this.innerApiCalls.restorePlaybookVersion(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('restorePlaybookVersion response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    deletePlaybookVersion(request, optionsOrCallback, callback) {
        ...
        const wrappedCallback = callback
            ...
            : undefined;
        return this.innerApiCalls.deletePlaybookVersion(request, options, wrappedCallback)
            ?.then(([response, options, rawResponse]) => {
            this._log.info('deletePlaybookVersion response %j', response);
            return [response, options, rawResponse];
        }).catch((error) => {
    ...
    exportPlaybook(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, rawResponse, _) => {
                this._log.info('exportPlaybook response %j', rawResponse);
                callback(error, response, rawResponse, _); // We verified callback above.
            }
            : undefined;
        this._log.info('exportPlaybook request %j', request);
        return this.innerApiCalls.exportPlaybook(request, options, wrappedCallback)
     ...
     */
    async checkExportPlaybookProgress(name) {
        this._log.info('exportPlaybook long-running');
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.exportPlaybook, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    importPlaybook(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        const wrappedCallback = callback
            ? (error, response, rawResponse, _) => {
                this._log.info('importPlaybook response %j', rawResponse);
                callback(error, response, rawResponse, _); // We verified callback above.
            }
            : undefined;
        this._log.info('importPlaybook request %j', request);
        return this.innerApiCalls.importPlaybook(request, options, wrappedCallback)
            ?.then(([response, rawResponse, _]) => {
            this._log.info('importPlaybook response %j', rawResponse);
            return [response, rawResponse, _];
        });
     ...
     */
    async checkImportPlaybookProgress(name) {
        this._log.info('importPlaybook long-running');
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.importPlaybook, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
