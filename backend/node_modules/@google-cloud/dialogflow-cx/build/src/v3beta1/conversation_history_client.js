...
exports.ConversationHistoryClient = void 0;
 ...
 */
const gapicConfig = require("./conversation_history_client_config.json");
...
class ConversationHistoryClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.ConversationHistory', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.conversationHistoryStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.ConversationHistory') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.cloud.dialogflow.cx.v3beta1.ConversationHistory, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const conversationHistoryStubMethods = ['listConversations', 'getConversation', 'deleteConversation'];
        for (const methodName of conversationHistoryStubMethods) {
            const callPromise = this.conversationHistoryStub.then(stub => (...args) => {
                if (this._terminated) {
...
exports.ConversationHistoryClient = ConversationHistoryClient;
//# sourceMappingURL=conversation_history_client.js.map